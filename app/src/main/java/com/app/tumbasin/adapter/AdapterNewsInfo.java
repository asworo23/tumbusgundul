package com.app.tumbasin.adapter;
...
public class AdapterNewsInfo extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public class OriginalViewHolder extends RecyclerView.ViewHolder {
        ...
        public OriginalViewHolder(View v) {
            ...
            featured = (TextView) v.findViewById(R.id.featured);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof OriginalViewHolder) {
            ...
            vItem.date.setText(Tools.getFormattedDateSimple(o.last_update));
            if (o.status.equalsIgnoreCase("FEATURED")) {
                vItem.featured.setVisibility(View.VISIBLE);
            } else {
                vItem.featured.setVisibility(View.GONE);
            }
            Tools.displayImageOriginal(ctx, vItem.image, Constant.getURLimgNews(o.image));
                ...
                public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                    ...
                    if (!loading && lastPos == getItemCount() - 1 && onLoadMoreListener != null) {
                        if (onLoadMoreListener != null) {
                            int current_page = getItemCount() / Constant.NEWS_PER_REQUEST;
