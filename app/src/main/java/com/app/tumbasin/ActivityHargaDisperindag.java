...
import com.app.tumbasin.adapter.AdapterNewsInfo;
...
import com.app.tumbasin.utils.NetworkCheck;
...
public class ActivityHargaDisperindag extends AppCompatActivity {
    ...
    private void initToolbar() {
        ...
        actionBar.setTitle(R.string.title_activity_harga_disperindag);
    ...
    public void iniComponent() {
        ...
        mAdapter.setOnItemClickListener(new AdapterNewsInfo.OnItemClickListener() {
            ...
            public void onItemClick(View v, NewsInfo obj, int position) {
                ActivityNewsInfoDetails.navigate(ActivityHargaDisperindag.this, obj.id, false);
            }
        });
