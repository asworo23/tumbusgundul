...
public class Constant {
    ...
    public static String WEB_URL = "http://admin.tumbas.in/";
    //public static String WEB_URL = "http://demo.dream-space.web.id/markeet_panel/";
    //private static String WEB_URL = "http://demo.dream-space.web.id/markeet_panel/";
    //public static String WEB_URL = "http://admin.tumbas.in";
    ...
    public static final String SECURITY_CODE = "jHJfSYHGWWeJWLZzVPag35PW8Fu8sySq69b2Oks9sNeLuCIUAIF3HdnJHjhvTpymhv3UMAlpo2ZkAW8YMyDGwEf56EInw0aaIbJ1";
